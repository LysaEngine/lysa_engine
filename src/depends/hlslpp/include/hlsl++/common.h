...
hlslpp_module_export namespace lysa
{
	//----------------
	// Float Constants
	//----------------
	...
	#define hlslpp_enable_if_return(T, R) typename lysa::enable_if<lysa::is_arithmetic<T>::value, R>::type
	
	#define hlslpp_enable_if_number(T) typename lysa::enable_if<lysa::is_arithmetic<T>::value, void*>::type = nullptr
	
	#define hlslpp_enable_if_number_2(T1, T2) \
			typename lysa::enable_if<lysa::is_arithmetic2<T1, T2>::value, void*>::type = nullptr
	
	#define hlslpp_enable_if_number_3(T1, T2, T3) \
			typename lysa::enable_if<lysa::is_arithmetic3<T1, T2, T3>::value, void*>::type = nullptr
	
	#define hlslpp_enable_if_number_4(T1, T2, T3, T4) \
			typename lysa::enable_if<lysa::is_arithmetic4<T1, T2, T3, T4>::value, void*>::type = nullptr

	#define hlslpp_enable_if_number_8(T1, T2, T3, T4, T5, T6, T7, T8) \
			typename lysa::enable_if<lysa::is_arithmetic8<T1, T2, T3, T4, T5, T6, T7, T8>::value, void*>::type = nullptr
