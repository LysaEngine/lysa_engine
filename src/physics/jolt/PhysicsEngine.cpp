...
namespace lysa {
    ...
    std::unique_ptr<PhysicsScene> JoltPhysicsEngine::createScene(const PhysicsDebugConfiguration& debugConfig) {
    ...
    void JoltPhysicsScene::debug(Vector3DRenderer& debugRenderer) {
